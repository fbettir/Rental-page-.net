    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2022, 9, 3, 0, 0, 0, 0, DateTimeKind.Local), 2, new DateTime(2022, 5, 26, 0, 0, 0, 0, DateTimeKind.Local), 1 },
                    { 2, new DateTime(2022, 9, 3, 0, 0, 0, 0, DateTimeKind.Local), 4, new DateTime(2022, 5, 26, 0, 0, 0, 0, DateTimeKind.Local), 1 },
                    { 3, new DateTime(2022, 9, 3, 0, 0, 0, 0, DateTimeKind.Local), 3, new DateTime(2022, 5, 26, 0, 0, 0, 0, DateTimeKind.Local), 2 },
                    { 4, new DateTime(2022, 9, 3, 0, 0, 0, 0, DateTimeKind.Local), 6, new DateTime(2022, 5, 26, 0, 0, 0, 0, DateTimeKind.Local), 3 }
                });
